                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <form action="${pageContext.request.contextPath}/servlet/RegistServlet"  method="post">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" name="username" value="${formBean.username}"/>  ${formBean.errors.username}
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label >Password</label>
                                                            <input type="password" class="form-control" name="password" value="${formBean.password}" />${formBean.errors.password}
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label >Repeat Password</label>
                                                            <input type="repassword" class="form-control" name="repassword" value="${formBean.repassword}"/>${formBean.errors.repassword}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-content-inner" data-content="login">
                                                <form action="${pageContext.request.contextPath}/servlet/LonginServlet"  method="post">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label >Username or Email</label>
